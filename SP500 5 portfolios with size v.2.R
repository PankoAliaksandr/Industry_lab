...
library(openxlsx)
  ...
  source( "D:/Industry Lab/pclasses.R")
  imp_path = file.path("D:/Industry Lab/Data Containers/SPCOMP")
  ...
  esg_sp500_monthly = read.csv(file = "D:/Industry Lab/SPCOMP_E_S_G_ESGCS_monthly.csv",header = TRUE, sep =";", dec = ",")
  
  # Read monthly simple ESG data
  simple_esg_sp500_monthly = read.csv(file = "D:/Industry Lab/SPCOMP_ESG_monthly.csv",header = TRUE, sep =";", dec = ",")
  ...
  for(i in 1:length(years)){
    ...
    for (j in 1:nrow(sp500_returns_current_year)){
      ...
      stock_codes_with_ESGCS = c()
      stock_codes_with_E = c()
      stock_codes_with_S = c()
      stock_codes_with_G = c()
      stock_codes_with_ESG = c()
      stock_codes_with_equal_ESG = c()
      ...
      sp500_ret_indices_cur_w_in_index = which(sp500_filter_current_week == 1)
      sp500_ret_cur_w_in_index = sp500_returns_current_week[sp500_ret_indices_cur_w_in_index]
      sp500_weights_cur_w_in_index = sp500_weights_current_week[sp500_ret_indices_cur_w_in_index]
      sp500_size_score_cur_w_in_index = sp500_size_score_current_week[sp500_ret_indices_cur_w_in_index]
      sp500_btp_score_cur_w_in_index = sp500_btp_score_current_week[sp500_ret_indices_cur_w_in_index]
      sp500_mom_score_cur_w_in_index = sp500_mom_score_current_week[sp500_ret_indices_cur_w_in_index]
      ...
      analyzed_size_score_for_ESGCS = unlist(sp500_size_score_cur_w_in_index[returns_col_indices_for_ESGCS])
      ...
      # Include size
      number_of_companies_in_size_group_ESGCS = num_comp_in_index_with_ESGCS_cur_w %/% 2
      number_of_companies_in_ESGCS_portfolio_current_week_in_size_group = number_of_companies_in_size_group_ESGCS %/% 5
      number_of_companies_in_ESGCS_portfolio_current_week = 2 * number_of_companies_in_ESGCS_portfolio_current_week_in_size_group
      
      small_size_score_for_ESGCS_indices =  which(analyzed_size_score_for_ESGCS <= sort(analyzed_size_score_for_ESGCS, decreasing=F)[number_of_companies_in_size_group_ESGCS], arr.ind=TRUE)[1:number_of_companies_in_size_group_ESGCS]                                     
      large_size_score_for_ESGCS_indices =  which(analyzed_size_score_for_ESGCS > sort(analyzed_size_score_for_ESGCS, decreasing=F)[number_of_companies_in_size_group_ESGCS], arr.ind=TRUE)[1:number_of_companies_in_size_group_ESGCS]                                     
      
      analyzed_ESGCS_small_size_score = analyzed_ESGCS[small_size_score_for_ESGCS_indices]
      analyzed_ESGCS_large_size_score = analyzed_ESGCS[large_size_score_for_ESGCS_indices]
      
      for(l in 1:(ncol(ESGCS_portfolios_returns)-2)){
        
        # Find constituents of portfolio 
        portfolio_ESGCS_indices_small_size_score = which(analyzed_ESGCS_small_size_score <= sort(analyzed_ESGCS_small_size_score, decreasing=F)[number_of_companies_in_ESGCS_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_ESGCS_portfolio_current_week_in_size_group]
        portfolio_ESGCS_indices_large_size_score = which(analyzed_ESGCS_large_size_score <= sort(analyzed_ESGCS_large_size_score, decreasing=F)[number_of_companies_in_ESGCS_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_ESGCS_portfolio_current_week_in_size_group]
        
        portfolio_ESGCS_names_small_size_score = names(analyzed_ESGCS_small_size_score)[portfolio_ESGCS_indices_small_size_score]
        portfolio_ESGCS_names_large_size_score = names(analyzed_ESGCS_large_size_score)[portfolio_ESGCS_indices_large_size_score]
        
        portfolio_ESGCS_names = c(portfolio_ESGCS_names_small_size_score, portfolio_ESGCS_names_large_size_score)
        portfolio_ESGCS_indices = unique(grep(paste(portfolio_ESGCS_names,collapse="|"), names(analyzed_ESGCS)))
        ...
        analyzed_ESGCS_small_size_score[portfolio_ESGCS_indices_small_size_score] = 1000000
        analyzed_ESGCS_large_size_score[portfolio_ESGCS_indices_large_size_score] = 1000000
  
        # Find stock codes in this portfolio
        portfolio_ESGCS_stock_codes = stock_codes_with_ESGCS[portfolio_ESGCS_indices]
        portfolio_ESGCS_stock_col_indices = unique(grep(paste(portfolio_ESGCS_stock_codes,collapse="|"), stock_codes_spcomp))
        ESGCS_stock_in_portfolio_df[week_number, portfolio_ESGCS_stock_col_indices] = l
      ...
      analyzed_size_score_for_E = unlist(sp500_size_score_cur_w_in_index[returns_col_indices_for_E])
      ...
      # Include size
      number_of_companies_in_size_group_E = num_comp_in_index_with_E_cur_w %/% 2
      number_of_companies_in_E_portfolio_current_week_in_size_group = number_of_companies_in_size_group_E %/% 5
      number_of_companies_in_E_portfolio_current_week = 2 * number_of_companies_in_E_portfolio_current_week_in_size_group
      
      small_size_score_for_E_indices =  which(analyzed_size_score_for_E <= sort(analyzed_size_score_for_E, decreasing=F)[number_of_companies_in_size_group_E], arr.ind=TRUE)[1:number_of_companies_in_size_group_E]                                     
      large_size_score_for_E_indices =  which(analyzed_size_score_for_E > sort(analyzed_size_score_for_E, decreasing=F)[number_of_companies_in_size_group_E], arr.ind=TRUE)[1:number_of_companies_in_size_group_E]                                     
      
      analyzed_E_small_size_score = analyzed_E[small_size_score_for_E_indices]
      analyzed_E_large_size_score = analyzed_E[large_size_score_for_E_indices]
      ...
      for(l in 1:(ncol(E_portfolios_returns)-2)){
        ...
        # Find constituents of portfolio 
        portfolio_E_indices_small_size_score = which(analyzed_E_small_size_score <= sort(analyzed_E_small_size_score, decreasing=F)[number_of_companies_in_E_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_E_portfolio_current_week_in_size_group]
        portfolio_E_indices_large_size_score = which(analyzed_E_large_size_score <= sort(analyzed_E_large_size_score, decreasing=F)[number_of_companies_in_E_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_E_portfolio_current_week_in_size_group]
        
        portfolio_E_names_small_size_score = names(analyzed_E_small_size_score)[portfolio_E_indices_small_size_score]
        portfolio_E_names_large_size_score = names(analyzed_E_large_size_score)[portfolio_E_indices_large_size_score]
        
        portfolio_E_names = c(portfolio_E_names_small_size_score, portfolio_E_names_large_size_score)
        portfolio_E_indices = unique(grep(paste(portfolio_E_names,collapse="|"), names(analyzed_E)))
        ...
        analyzed_E_small_size_score[portfolio_E_indices_small_size_score] = 1000000
        analyzed_E_large_size_score[portfolio_E_indices_large_size_score] = 1000000
        
        # Find stock codes in this portfolio
        portfolio_E_stock_codes = stock_codes_with_E[portfolio_E_indices]
        portfolio_E_stock_col_indices = unique(grep(paste(portfolio_E_stock_codes,collapse="|"), stock_codes_spcomp))
        E_stock_in_portfolio_df[week_number, portfolio_E_stock_col_indices] = l
      ...
      analyzed_size_score_for_S = unlist(sp500_size_score_cur_w_in_index[returns_col_indices_for_S])
      ...
      # Include size
      number_of_companies_in_size_group_S = num_comp_in_index_with_S_cur_w %/% 2
      number_of_companies_in_S_portfolio_current_week_in_size_group = number_of_companies_in_size_group_S %/% 5
      number_of_companies_in_S_portfolio_current_week = 2 * number_of_companies_in_S_portfolio_current_week_in_size_group
      
      small_size_score_for_S_indices =  which(analyzed_size_score_for_S <= sort(analyzed_size_score_for_S, decreasing=F)[number_of_companies_in_size_group_S], arr.ind=TRUE)[1:number_of_companies_in_size_group_S]                                     
      large_size_score_for_S_indices =  which(analyzed_size_score_for_S > sort(analyzed_size_score_for_S, decreasing=F)[number_of_companies_in_size_group_S], arr.ind=TRUE)[1:number_of_companies_in_size_group_S]                                     
      
      analyzed_S_small_size_score = analyzed_S[small_size_score_for_S_indices]
      analyzed_S_large_size_score = analyzed_S[large_size_score_for_S_indices]
      
      for(l in 1:(ncol(S_portfolios_returns)-2)){
        
        # Find constituents of portfolio 
        portfolio_S_indices_small_size_score = which(analyzed_S_small_size_score <= sort(analyzed_S_small_size_score, decreasing=F)[number_of_companies_in_S_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_S_portfolio_current_week_in_size_group]
        portfolio_S_indices_large_size_score = which(analyzed_S_large_size_score <= sort(analyzed_S_large_size_score, decreasing=F)[number_of_companies_in_S_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_S_portfolio_current_week_in_size_group]
        
        portfolio_S_names_small_size_score = names(analyzed_S_small_size_score)[portfolio_S_indices_small_size_score]
        portfolio_S_names_large_size_score = names(analyzed_S_large_size_score)[portfolio_S_indices_large_size_score]
        
        portfolio_S_names = c(portfolio_S_names_small_size_score, portfolio_S_names_large_size_score)
        portfolio_S_indices = unique(grep(paste(portfolio_S_names,collapse="|"), names(analyzed_S)))
        ...
        analyzed_S_small_size_score[portfolio_S_indices_small_size_score] = 1000000
        analyzed_S_large_size_score[portfolio_S_indices_large_size_score] = 1000000
        
        # Find stock codes in this portfolio
        portfolio_S_stock_codes = stock_codes_with_S[portfolio_S_indices]
        portfolio_S_stock_col_indices = unique(grep(paste(portfolio_S_stock_codes,collapse="|"), stock_codes_spcomp))
        S_stock_in_portfolio_df[week_number, portfolio_S_stock_col_indices] = l
      ...
      analyzed_size_score_for_G = unlist(sp500_size_score_cur_w_in_index[returns_col_indices_for_G])
      ...
      # Include size
      number_of_companies_in_size_group_G = num_comp_in_index_with_G_cur_w %/% 2
      number_of_companies_in_G_portfolio_current_week_in_size_group = number_of_companies_in_size_group_G %/% 5
      number_of_companies_in_G_portfolio_current_week = 2 * number_of_companies_in_G_portfolio_current_week_in_size_group
      
      small_size_score_for_G_indices =  which(analyzed_size_score_for_G <= sort(analyzed_size_score_for_G, decreasing=F)[number_of_companies_in_size_group_G], arr.ind=TRUE)[1:number_of_companies_in_size_group_G]                                     
      large_size_score_for_G_indices =  which(analyzed_size_score_for_G > sort(analyzed_size_score_for_G, decreasing=F)[number_of_companies_in_size_group_G], arr.ind=TRUE)[1:number_of_companies_in_size_group_G]                                     
      
      analyzed_G_small_size_score = analyzed_G[small_size_score_for_G_indices]
      analyzed_G_large_size_score = analyzed_G[large_size_score_for_G_indices]
      
      for(l in 1:(ncol(G_portfolios_returns)-2)){
        
        # Find constituents of portfolio 
        portfolio_G_indices_small_size_score = which(analyzed_G_small_size_score <= sort(analyzed_G_small_size_score, decreasing=F)[number_of_companies_in_G_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_G_portfolio_current_week_in_size_group]
        portfolio_G_indices_large_size_score = which(analyzed_G_large_size_score <= sort(analyzed_G_large_size_score, decreasing=F)[number_of_companies_in_G_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_G_portfolio_current_week_in_size_group]
        
        portfolio_G_names_small_size_score = names(analyzed_G_small_size_score)[portfolio_G_indices_small_size_score]
        portfolio_G_names_large_size_score = names(analyzed_G_large_size_score)[portfolio_G_indices_large_size_score]
        
        portfolio_G_names = c(portfolio_G_names_small_size_score, portfolio_G_names_large_size_score)
        portfolio_G_indices = unique(grep(paste(portfolio_G_names,collapse="|"), names(analyzed_G)))
        ...
        analyzed_G_small_size_score[portfolio_G_indices_small_size_score] = 1000000
        analyzed_G_large_size_score[portfolio_G_indices_large_size_score] = 1000000
        
        # Find stock codes in this portfolio
        portfolio_G_stock_codes = stock_codes_with_G[portfolio_G_indices]
        portfolio_G_stock_col_indices = unique(grep(paste(portfolio_G_stock_codes,collapse="|"), stock_codes_spcomp))
        G_stock_in_portfolio_df[week_number, portfolio_G_stock_col_indices] = l
      ...
      # Find stock codes in this portfolio
      all_best_stock_col_indices = unique(grep(paste(all_best_stocks, collapse="|"), stock_codes_spcomp))
      all_best_stock_in_portfolio_df[week_number, all_best_stock_col_indices] = 1
      ...
      analyzed_size_score_for_ESG = unlist(sp500_size_score_cur_w_in_index[returns_col_indices_for_ESG])
      ...
      # Include size
      number_of_companies_in_size_group_ESG = num_comp_in_index_with_ESG_cur_w %/% 2
      number_of_companies_in_ESG_portfolio_current_week_in_size_group = number_of_companies_in_size_group_ESG %/% 5
      number_of_companies_in_ESG_portfolio_current_week = 2 * number_of_companies_in_ESG_portfolio_current_week_in_size_group
      
      small_size_score_for_ESG_indices =  which(analyzed_size_score_for_ESG <= sort(analyzed_size_score_for_ESG, decreasing=F)[number_of_companies_in_size_group_ESG], arr.ind=TRUE)[1:number_of_companies_in_size_group_ESG]                                     
      large_size_score_for_ESG_indices =  which(analyzed_size_score_for_ESG > sort(analyzed_size_score_for_ESG, decreasing=F)[number_of_companies_in_size_group_ESG], arr.ind=TRUE)[1:number_of_companies_in_size_group_ESG]                                     
      
      analyzed_ESG_small_size_score = analyzed_ESG[small_size_score_for_ESG_indices]
      analyzed_ESG_large_size_score = analyzed_ESG[large_size_score_for_ESG_indices]
      
      for(l in 1:(ncol(ESG_portfolios_returns)-2)){
        
        # Find constituents of portfolio 
        portfolio_ESG_indices_small_size_score = which(analyzed_ESG_small_size_score <= sort(analyzed_ESG_small_size_score, decreasing=F)[number_of_companies_in_ESG_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_ESG_portfolio_current_week_in_size_group]
        portfolio_ESG_indices_large_size_score = which(analyzed_ESG_large_size_score <= sort(analyzed_ESG_large_size_score, decreasing=F)[number_of_companies_in_ESG_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_ESG_portfolio_current_week_in_size_group]
        
        portfolio_ESG_names_small_size_score = names(analyzed_ESG_small_size_score)[portfolio_ESG_indices_small_size_score]
        portfolio_ESG_names_large_size_score = names(analyzed_ESG_large_size_score)[portfolio_ESG_indices_large_size_score]
        
        portfolio_ESG_names = c(portfolio_ESG_names_small_size_score, portfolio_ESG_names_large_size_score)
        portfolio_ESG_indices = unique(grep(paste(portfolio_ESG_names,collapse="|"), names(analyzed_ESG)))
        ...
        analyzed_ESG_small_size_score[portfolio_ESG_indices_small_size_score] = 1000000
        analyzed_ESG_large_size_score[portfolio_ESG_indices_large_size_score] = 1000000
        
        # Find stock codes in this portfolio
        portfolio_ESG_stock_codes = stock_codes_with_ESG[portfolio_ESG_indices]
        portfolio_ESG_stock_col_indices = unique(grep(paste(portfolio_ESG_stock_codes,collapse="|"), stock_codes_spcomp))
        ESG_stock_in_portfolio_df[week_number, portfolio_ESG_stock_col_indices] = l
      ...
      analyzed_size_score_for_equal_ESG = unlist(sp500_size_score_cur_w_in_index[returns_col_indices_for_equal_ESG])
      ...
      # Include size
      number_of_companies_in_size_group_equal_ESG = num_comp_in_index_with_equal_ESG_cur_w %/% 2
      number_of_companies_in_equal_ESG_portfolio_current_week_in_size_group = number_of_companies_in_size_group_equal_ESG %/% 5
      number_of_companies_in_equal_ESG_portfolio_current_week = 2 * number_of_companies_in_equal_ESG_portfolio_current_week_in_size_group
      
      small_size_score_for_equal_ESG_indices =  which(analyzed_size_score_for_equal_ESG <= sort(analyzed_size_score_for_equal_ESG, decreasing=F)[number_of_companies_in_size_group_equal_ESG], arr.ind=TRUE)[1:number_of_companies_in_size_group_equal_ESG]                                     
      large_size_score_for_equal_ESG_indices =  which(analyzed_size_score_for_equal_ESG > sort(analyzed_size_score_for_equal_ESG, decreasing=F)[number_of_companies_in_size_group_equal_ESG], arr.ind=TRUE)[1:number_of_companies_in_size_group_equal_ESG]                                     
      
      analyzed_equal_ESG_small_size_score = analyzed_equal_ESG[small_size_score_for_equal_ESG_indices]
      analyzed_equal_ESG_large_size_score = analyzed_equal_ESG[large_size_score_for_equal_ESG_indices]
      
      for(l in 1:(ncol(equal_ESG_portfolios_returns)-2)){
        
        # Find constituents of portfolio 
        portfolio_equal_ESG_indices_small_size_score = which(analyzed_equal_ESG_small_size_score <= sort(analyzed_equal_ESG_small_size_score, decreasing=F)[number_of_companies_in_equal_ESG_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_equal_ESG_portfolio_current_week_in_size_group]
        portfolio_equal_ESG_indices_large_size_score = which(analyzed_equal_ESG_large_size_score <= sort(analyzed_equal_ESG_large_size_score, decreasing=F)[number_of_companies_in_equal_ESG_portfolio_current_week_in_size_group], arr.ind=TRUE)[1:number_of_companies_in_equal_ESG_portfolio_current_week_in_size_group]
        
        portfolio_equal_ESG_names_small_size_score = names(analyzed_equal_ESG_small_size_score)[portfolio_equal_ESG_indices_small_size_score]
        portfolio_equal_ESG_names_large_size_score = names(analyzed_equal_ESG_large_size_score)[portfolio_equal_ESG_indices_large_size_score]
        
        portfolio_equal_ESG_names = c(portfolio_equal_ESG_names_small_size_score, portfolio_equal_ESG_names_large_size_score)
        portfolio_equal_ESG_indices = unique(grep(paste(portfolio_equal_ESG_names,collapse="|"), names(analyzed_equal_ESG)))
        ...
        analyzed_equal_ESG_small_size_score[portfolio_equal_ESG_indices_small_size_score] = 1000000
        analyzed_equal_ESG_large_size_score[portfolio_equal_ESG_indices_large_size_score] = 1000000
        
        # Find stock codes in this portfolio
        portfolio_equal_ESG_stock_codes = stock_codes_with_equal_ESG[portfolio_equal_ESG_indices]
        portfolio_equal_ESG_stock_col_indices = unique(grep(paste(portfolio_equal_ESG_stock_codes,collapse="|"), stock_codes_spcomp))
        equal_ESG_stock_in_portfolio_df[week_number, portfolio_equal_ESG_stock_col_indices] = l
  ...
  # Export ESGCS_stock_in_portfolio_df to Excel
  addWorksheet(wb, "ESGCS_stock_in_portfolio_df")
  writeData(wb, "ESGCS_stock_in_portfolio_df", ESGCS_stock_in_portfolio_df)
  setColWidths(wb, sheet = "ESGCS_stock_in_portfolio_df", cols = 1:ncol(ESGCS_stock_in_portfolio_df), widths = "auto")
  
  # Export E_stock_in_portfolio_df to Excel
  addWorksheet(wb, "E_stock_in_portfolio_df")
  writeData(wb, "E_stock_in_portfolio_df", E_stock_in_portfolio_df)
  setColWidths(wb, sheet = "E_stock_in_portfolio_df", cols = 1:ncol(E_stock_in_portfolio_df), widths = "auto")
  
  # Export S_stock_in_portfolio_df to Excel
  addWorksheet(wb, "S_stock_in_portfolio_df")
  writeData(wb, "S_stock_in_portfolio_df", S_stock_in_portfolio_df)
  setColWidths(wb, sheet = "S_stock_in_portfolio_df", cols = 1:ncol(S_stock_in_portfolio_df), widths = "auto")
  
  # Export G_stock_in_portfolio_df to Excel
  addWorksheet(wb, "G_stock_in_portfolio_df")
  writeData(wb, "G_stock_in_portfolio_df", G_stock_in_portfolio_df)
  setColWidths(wb, sheet = "G_stock_in_portfolio_df", cols = 1:ncol(G_stock_in_portfolio_df), widths = "auto")
  
  # Export ESG_stock_in_portfolio_df to Excel
  addWorksheet(wb, "ESG_stock_in_portfolio_df")
  writeData(wb, "ESG_stock_in_portfolio_df", ESG_stock_in_portfolio_df)
  setColWidths(wb, sheet = "ESG_stock_in_portfolio_df", cols = 1:ncol(ESG_stock_in_portfolio_df), widths = "auto")
  
  # Export equal_ESG_stock_in_portfolio_df to Excel
  addWorksheet(wb, "equal_ESG_stock_in_portfolio_df")
  writeData(wb, "equal_ESG_stock_in_portfolio_df", equal_ESG_stock_in_portfolio_df)
  setColWidths(wb, sheet = "equal_ESG_stock_in_portfolio_df", cols = 1:ncol(equal_ESG_stock_in_portfolio_df), widths = "auto")
  
  # Export all_best_stock_in_portfolio_df to Excel
  addWorksheet(wb, "all_best_stock_in_portfolio_df")
  writeData(wb, "all_best_stock_in_portfolio_df", all_best_stock_in_portfolio_df)
  setColWidths(wb, sheet = "all_best_stock_in_portfolio_df", cols = 1:ncol(all_best_stock_in_portfolio_df), widths = "auto")
  
  # Save final workbook
  final_file_path = 'D:/Industry Lab/ Final.xlsx'
